///Continous///
import excel "C:\Users\Jin Eui Kim\OneDrive\obesity_meta_data\BRI\BRI_meta.xlsx", sheet("continuous") firstrow clear
...
///GLST///
import excel "C:\Users\Jin Eui Kim\OneDrive\obesity_meta_data\BRI\BRI_meta.xlsx", sheet("categorical") firstrow clear
...
/*HKSJ method*/
/*BMI unadjusted*/
import excel "C:\Users\Jin Eui Kim\OneDrive\obesity_meta_data\BRI\BRI_meta.xlsx", sheet("linear_main") firstrow clear
...
gen double rug_all_y = 1 if inrange(dose, 2, 8)
gen double rug_ref_y = 1 if refcat & inrange(dose, 2, 8)
	
drmeta_graph, matk(knots) dose(2(0.01)8) list ref(`nadir') eform ///
    xtitle("BRI", size(large)) ///
    ytitle("RR", size(large)) ///
    yline(1, lcolor(gs10) lpattern(line)) ///
    ylabel(0.6 0.8 1 (0.5) 4.0, labsize(large)) ///
    xlabel(2(1)8, labsize(large)) ///
