...
///Categorical///
import excel "C:\Users\WHR\WHR_meta.xlsx", sheet("categorical") firstrow clear
...
///Continous///
import excel "C:\Users\WHR\WHR_meta.xlsx", sheet("continuous") firstrow clear
...
/*HKSJ method*/
/*BMI unadjusted*/
import excel "C:\Users\WHR\WHR_meta.xlsx", sheet("linear_main") firstrow clear
...
/*BMI unadjusted*/
import excel "C:\Users\WHR\WHR_meta.xlsx", sheet("linear_open") firstrow clear
keep if bmi_unadjusted == 1
keep if minimum == 1
meta set coef se, studylabel(Studyname)
meta summarize, random(reml) se(khartung)
...
/*Open ended*/
/*BMI unadjusted*/
import excel "C:\Users\WHR\WHR_meta.xlsx", sheet("categorical_open") firstrow clear
