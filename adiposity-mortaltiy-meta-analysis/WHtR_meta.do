...
///Categorical///
import excel "C:\Users\WHtR\WHtR_meta_final.xlsx", sheet("categorical") firstrow clear
...
///continuous///
import excel "C:\Users\WHtR\WHtR_meta_final.xlsx", sheet("continous") firstrow clear
...
import excel "C:\Users\WHtR\WHtR_meta_final.xlsx", sheet("continuous") firstrow clear
...
/*HKSJ method*/
/*BMI unadjusted*/
import excel "C:\Users\WHtR\WHtR_meta_final.xlsx", sheet("linear_main") firstrow clear
...
/*BMI unadjusted*/
import excel "C:\Users\WHtR\WHtR_meta_final.xlsx", sheet("linear_open") firstrow clear
keep if bmi_unadjusted == 1
keep if minimum == 1
meta set coef se, studylabel(Studyname)
meta summarize, random(reml) se(khartung)
...
mkspline doses = dose, knots(`p5' `p50' `p95') cubic displayknots
matrix knots = r(knots)
...
/*Open ended*/
/*BMI unadjusted*/
import excel "C:\Users\WHtR\WHtR_meta_final.xlsx", sheet("categorical_open") firstrow clear
