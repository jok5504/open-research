...
import excel "C:\Users\Jin Eui Kim\OneDrive\obesity_meta_data\ABSI\ABSI_meta_final.xlsx", sheet("continuous") firstrow clear
...
///GLST///
import excel "C:\Users\Jin Eui Kim\OneDrive\obesity_meta_data\ABSI\ABSI_meta_final.xlsx", sheet("categorical") firstrow clear
...
/*HKSJ method*/
/*BMI unadjusted*/
import excel "C:\Users\Jin Eui Kim\OneDrive\obesity_meta_data\ABSI\ABSI_meta_final.xlsx", sheet("linear_main") firstrow clear
...
/*BMI unadjusted*/
import excel "C:\Users\Jin Eui Kim\OneDrive\obesity_meta_data\ABSI\ABSI_meta_final.xlsx", sheet("linear_open") firstrow clear
keep if bmi_unadjusted == 1
keep if minimum == 1
meta set coef se, studylabel(Studyname)
meta summarize, random(reml) se(khartung)
...
keep if bmi_adjusted == 1 /*bmi_adjusted == 1*/
keep if full_model == 1
keep if minimum == 1
...
keep if bmi_unadjusted == 1 /*bmi_adjusted == 1*/
keep if full_model == 1
keep if minimum == 1
...
/*Open ended*/
import excel "C:\Users\Jin Eui Kim\OneDrive\obesity_meta_data\ABSI\ABSI_meta_final.xlsx", sheet("categorical_open") firstrow clear
...
twoway ///
	(line fit_hi_plot dose_curve if curveobs == 1, ///
    sort lcolor(black) lpattern("-#") lwidth(medium)) ///
	(line fit_lo_plot dose_curve if curveobs == 1, ///
    sort lcolor(black) lpattern("-#") lwidth(medium)) ///
    (line fit_rr_plot dose_curve if curveobs == 1, ///
        sort lcolor(black) lpattern(solid) lwidth(medium)) ///
