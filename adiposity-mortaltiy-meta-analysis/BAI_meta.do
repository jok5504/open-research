///Continuous///
import excel "C:\Users\BAI\BAI_meta.xlsx",  sheet("continous") firstrow clear
...
///GLST///
import excel "C:\Users\BAI\BAI_meta.xlsx", sheet("categorical") firstrow clear
...
/*linear*/
import excel "C:\Users\BAI\BAI_meta.xlsx", sheet("linear_main") firstrow clear
...
gen double rug_all_y = 1 if inrange(dose, 20, 40)
gen double rug_ref_y = 1 if refcat & inrange(dose, 20, 40)
	
drmeta_graph, matk(knots) dose(20(0.1)40) list ref(`nadir') eform ///
    xtitle("BAI (%)", size(large)) ///
    ytitle("RR", size(large)) ///
    yline(1, lcolor(gs10) lpattern(line)) ///
    ylabel(0.6 0.8 1 (0.5) 4.0, labsize(large)) ///
    xlabel(20(5)40, labsize(large)) ///
